...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CodenamesClient = void 0;
var constants_1 = __webpack_require__(140);
var codenames_server_1 = __webpack_require__(824);
var messages_1 = __webpack_require__(349);
var CodenamesClient = /** @class */ (function () {
    function CodenamesClient() {
    }
    CodenamesClient.prototype.preload = function (entityId) {
        var _this = this;
        this.mousePressOnEntityFn = function (id, event) {
            _this.onMousePress(id, event);
        };
        if (constants_1.CONFIG.CLIENT_SIDE_ONLY) {
            this.server = new codenames_server_1.CodenamesServer();
    ...
    CodenamesClient.prototype.onMousePress = function (entityId, event) {
        ...
        if (HMD.active && this.lastClickTime + constants_1.CONFIG.CLICK_THROTTLE > clickTime) {
            return;
        }
        var match = name.match(/^Text.BoardWord\[(\d+)\]$/);
        if (match !== null) {
        ...
        switch (name) {
            ...
            case 'Text.Panel.Abort':
                ...
                break;
            case 'Text.Panel.RedPlus':
                this.callServer('increaseGuesses', [messages_1.Message.RED]);
                break;
            case 'Text.Panel.RedMinus':
                this.callServer('decreaseGuesses', [messages_1.Message.RED]);
                break;
            case 'Text.Panel.BluePlus':
                this.callServer('increaseGuesses', [messages_1.Message.BLUE]);
                break;
            case 'Text.Panel.BlueMinus':
                this.callServer('decreaseGuesses', [messages_1.Message.BLUE]);
                break;
            case 'Text.Panel.RedWord':
                value = (Window.prompt(messages_1.Message.ENTER_CLUE, '') || '').trim();
                this.callServer('setWord', [messages_1.Message.RED, value]);
                break;
            case 'Text.Panel.BlueWord':
                value = (Window.prompt(messages_1.Message.ENTER_CLUE, '') || '').trim();
                this.callServer('setWord', [messages_1.Message.BLUE, value]);
                break;
            case 'Text.Panel.RedSubmit':
                this.callServer('submitClue', [messages_1.Message.RED]);
                break;
            case 'Text.Panel.BlueSubmit':
                this.callServer('submitClue', [messages_1.Message.BLUE]);
                break;
        }
    };
    return CodenamesClient;
}());
exports.CodenamesClient = CodenamesClient;
exports["default"] = new CodenamesClient();
